! function () {
	...
	window.UEDITOR_CONFIG = {
		toolbars: [
			["undo", "redo", "|", "fontsize", "blockquote", "|", "removeformat", "formatmatch", "|", "link", "emotion",
				"spechars", "superscript", "subscript", "|", "PastePlain", "directionalityltr",
				"directionalityrtl", "|", 'touppercase', 'tolowercase'],

			["bold", "italic", "underline", "strikethrough", "horizontal", "|", "forecolor", "shadowcolor", "backcolor",
				"|", "indent", "lineheight", 'letterspacing', 'outpadding', "rowspacingtop", "rowspacingbottom",
				"|", "insertorderedlist", "insertunorderedlist", ],

			["autotypeset", "|", "justifyleft", "justifycenter", "justifyright", "justifyjustify", "|", "insertvideo",
				"music", 'background', 'insertimage', "searchreplace", "source", "dydata"]
		],
		zIndex: 0,
		charset: "utf-8",
		textarea: "content",
