  ...
  <div class="home_material_container">
    <div class="header_material">
      <div class="header_class">
        ...
        <span style="display:-moz-inline-box; display:inline-block;width: 87px;text-align: center" @click="_getUserFramework()">
          我的模板
        </span>
        <span style="display:-moz-inline-box; display:inline-block;width: 87px;text-align: center">
          我的收藏
        </span>
      </div>
    </div>
    <div class="content_material">
      ...
      >
        <li v-for="(item, i) in templateList" :key="i" class="material_item" @click="_insertToImage(item)">
          <div>
...
<script>
  import {getFrameWork, getFrameworkCategory,getUserFramework} from "../api/home";
  export default {
    name: "HomePicture",
    data() {
      return {
    ...
    methods: {
      ...
      _getUserFramework(){
        ...
        getUserFramework(params).then(res => {
          this.loading = false
      ...
      _getFrameworkCategory() {
        getFrameworkCategory().then(res => {
